...
void proximity(int index, const std::vector<std::vector<float>>& points, std::vector<int>& cluster, std::vector<bool>& processed, float distanceTol, KdTree* tree)
{
	...
	{
		if (!processed[id])
			proximity(id,points,cluster,processed,distanceTol,tree);
	}
}
...
std::vector<std::vector<int>> euclideanCluster(const std::vector<std::vector<float>>& points, KdTree* tree, float distanceTol)
{
	...
	while( i< points.size())
	{
		...
		proximity(i,points,cluster,processed,distanceTol,tree);
